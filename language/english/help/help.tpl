<div id="help-template" class="outer">
    <h1 class="head">Help:
        <a class="ui-corner-all tooltip" href="<{$xoops_url}>/modules/smartobject/admin/index.php"
           title="Back to the administration of SmartObject"> SmartObject
            <img src="<{xoAdminIcons home.png}>"
                 alt="Back to the Administration of SmartObject">
        </a></h1>

    <h4 class="odd">DESCRIPTION</h4>

    <p class="even">This module is Framework providing functionality to SmartModules.<br> <br>
    </p>
