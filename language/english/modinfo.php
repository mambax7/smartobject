...
//1.12
//Help
define('_MI_SOBJECT_DIRNAME', basename(dirname(dirname(__DIR__))));
define('_MI_SOBJECT_HELP_HEADER', __DIR__.'/help/helpheader.tpl');
define('_MI_SOBJECT_BACK_2_ADMIN', 'Back to Administration of ');
define('_MI_SOBJECT_OVERVIEW', 'Overview');

//define('_MI_SOBJECT_HELP_DIR', __DIR__);
