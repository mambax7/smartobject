...
<div style='line-height: 16px; font-weight: bold;'>
    <{$smarty.const._AM_SOBJECT_BY}> <{$module_author_name}>
</div>
...
<{if $module_credits}>
    <table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
        <tr>
            <td class='bg3'><b><{$smarty.const._CO_SOBJECT_DEVELOPER_CREDITS}></b></td>
        </tr>
...
<table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
    <tr>
        <td colspan='2' class='bg3'>
            <b><{$smarty.const._AM_SOBJECT_AUTHOR_INFO}></b>
        </td>
    </tr>

    <{if $module_developer_lead}>
        <tr>
            <td class='head' width='150px'><{$smarty.const._AM_SOBJECT_DEVELOPER_LEAD}></td>
    ...
    <{if $module_developer_contributor}>
        <tr>
            <td class='head' width='150px'><{$smarty.const._AM_SOBJECT_DEVELOPER_CONTRIBUTOR}></td>
    ...
    <{if $module_people_other}>
        <tr>
            <td class='head' style="vertical-align: top;" width='150px'><{$smarty.const._AM_SOBJECT_PEOPLE_OTHER}></td>
            <td class='even'>
...
<table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
    <tr>
        <td colspan='2' class='bg3'><b><{$smarty.const._AM_SOBJECT_MODULE_INFO}></b></td>
    </tr>

    <tr>
        <td class='head' width='200px'><{$smarty.const._AM_SOBJECT_MODULE_RELEASE_DATE}></td>
        <td class='even'><{$module_date}></td>
    </tr>

    <tr>
        <td class='head' width='200px'><{$smarty.const._AM_SOBJECT_MODULE_STATUS}></td>
...
<table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
    <tr>
        <td class='bg3'><b><{$smarty.const._CO_SOBJECT_MODULE_DISCLAIMER}></b></td>
    </tr>
...
<{if $module_author_word}>
    <table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
        <tr>
            <td class='bg3'><b><{$smarty.const._CO_SOBJECT_AUTHOR_WORD}></b></td>
        </tr>
...
<table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
    <tr>
        <td class='bg3'><b><{$smarty.const._CO_SOBJECT_VERSION_HISTORY}></b></td>
    </tr>
